...
Give the project a name (e.g. **00_test**) and leave the default location under the workspace unless you need a different path. Click **Finish** to create the project.
...
STM32CubeIDE will generate the project with startup code, linker script, and a default `main.c`. You should see the project in **Project Explorer** with folders such as **Core/Inc**, **Core/Src**, **Startup**, etc.
...
1. In **Project Explorer**, open **Core/Src/main.c**.
...
If the build succeeds, your STM32CubeIDE setup and toolchain are correct and you are ready to add clocks, GPIO, and other bare-metal code in the next lessons.
